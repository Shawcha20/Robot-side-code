...
tilt = AngularServo(25, min_angle=0, max_angle=270,
                    min_pulse_width=0.0005, max_pulse_width=0.0025)
...
# --- tuning (KP=11, KD=2 gave perfect positioning on this hardware) ---
DEAD_ZONE = 0.05
KP = 17.0
KD = 1.0
SMOOTH = 0.6
...
MOVE_SETTLE = 0.04      # brief pulse to start the move, then detach
...
try:
    while True:
        ...
        if res.pose_landmarks:
            ...
            # if either servo moved, brief pulse then cut signal (no holding jitter)
            if moved:
