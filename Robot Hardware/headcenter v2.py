...
DEAD_ZONE = 0.14        # wide rest zone: face must drift a lot before moving
KP = 8.0                # gentle proportional
KD = 4.0                # damping
SMOOTH = 0.8            # heavy smoothing -> steady input
MAX_STEP = 6.0
MIN_MOVE = 2.5          # only move for sizable corrections (kills micro-twitch)
