...
<section id="tab-tuning" class="tab">
  <div class="note" style="margin:10px">Available after balancing firmware is completed. This layout is final —
    Phase 4/5 only need to enable these controls and wire them to STM32 parameter get/set; no redesign.</div>
