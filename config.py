...
# ----- paths / device -----
BASE = r"D:\thesis\shawcha thesis main dataset\thesis"
...
HT_DEAD = 0.05; HT_KP = 17.0; HT_KD = 1.0; HT_SMOOTH = 0.6   # KP/KD matched to verified standalone
HT_MAX_STEP = 2.5; HT_MIN_MOVE = 0.6; HT_SETTLE = 0.04; HT_CENTER = 135.0
PAN_PIN, TILT_PIN = 22, 25   # TILT corrected 23->25 to match verified head-tracking wiring
PAN_MIN, PAN_MAX, TILT_MIN, TILT_MAX = 30, 240, 115, 150   # tilt narrowed to 115-150
PAN_DIR, TILT_DIR = -1, 1

# optional: fix specific words if auto-transliteration looks off  {class_id: "banglish"}
ROMAN_OVERRIDE = {}

# descriptive only -- shown on the dashboard System tab; no effect on any behavior
SOFTWARE_VERSION = "Ishara Phase 3d-6"
